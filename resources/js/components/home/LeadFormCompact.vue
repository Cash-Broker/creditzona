    ...
    <div class="relative">
        <transition name="success-swap" mode="out-in">
            ...
            <div class="success-shell">
                ...
                <div class="success-kicker">Заявка за безплатна консултация</div>
                <h3 class="success-title">Заявката ви за консултация е приета</h3>
            ...
            >
                ...
                <div class="guard-dialog">
                    ...
                    <h3 id="consumer-upsell-title" class="guard-title">
                        Повече възможности с поръчител
                    </h3>

                    <p class="guard-note">
                        Имате ли възможен поръчител? Това разширява вариантите,
