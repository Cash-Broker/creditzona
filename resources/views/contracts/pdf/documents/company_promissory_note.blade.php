...
<p>С НАСТОЯЩИЯ “ЗАПИС НА ЗАПОВЕД”, ИЗДАТЕЛЯТ СЕ ЗАДЪЛЖАВА НЕОТМЕНИМО И БЕЗУСЛОВНО ДА ЗАПЛАТИ НА ПОЕМАТЕЛЯ</p>
<p>СУМАТА ОТ {{ data_get($derived, 'financial.company_promissory_note_amount.eur.formatted') }} € ({{ data_get($derived, 'financial.company_promissory_note_amount.eur.words') }}) /{{ data_get($derived, 'financial.company_promissory_note_amount.bgn.formatted') }} лв./</p>
