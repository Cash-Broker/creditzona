...
<div style="margin-top: 40px;">
    <p><strong>ВЪЗЛОЖИТЕЛ</strong>/ПРИЕЛ: ________________________________________________________</p>
</div>

<div style="margin-top: 40px;">
    <p><strong>ИЗПЪЛНИТЕЛ</strong>/ПРЕДАЛ: ________________________________________________________</p>
</div>
