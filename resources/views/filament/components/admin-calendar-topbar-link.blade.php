@php
    ...
    $hasCount = $todayCount !== null && $todayCount > 0;
@endphp
...
<a
    ...
    aria-label="Календар@if ($hasCount) ({{ $todayCount }} за днес)@endif"
>
    ...
    <span class="fi-admin-calendar-topbar-link-label">Календар</span>

    @if ($hasCount)
        <span class="fi-admin-calendar-topbar-link-badge">{{ $todayCount }}</span>
    @endif
</a>
